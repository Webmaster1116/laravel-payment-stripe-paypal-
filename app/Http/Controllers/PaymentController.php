...
echo("dasdasdasdasdasd");
echo(Input::get('PayerID'));
    ...
    public function payment_select() {
        //echo("2342222222222222");
        return view('pages.payment_select');
    }

    public function payment_select_1  (Request $request) {
    

        if($request->select_pay == "0") {
            //return view("pages.stripe");
            return Redirect::to('/stripe');
        }
        if($request->select_pay == "1") {
          return view("pages.paywithpaypal");
        }
    }
